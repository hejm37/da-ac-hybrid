...
https://github.com/TJU-DRL-LAB/self-supervised-rl/blob/ece95621b8c49f154f96cf7d395b95362a3b3d4e/RL_with_Action_Representation/HyAR/Raw_RL/main_direction_catch_hhqn_td3.py
...
def run(args):
    ...
    while total_timesteps < args.max_timesteps:
        ...
        for i in range(max_steps):
            ...
            if total_timesteps % args.eval_freq == 0:
                ...
                Test_Reward_50, Test_success_rate, Test_epioside_step_50 = evaluate(env, policy,  max_steps=25, episodes=50)
    ...
    print("save txt")
    dir = "result/hhqn/direction_catch"
    data = "log"
    ...
    title2 = "Reward_100_hhqn_td3_direction_catch_"
    title3 = "Test_Reward_hhqn_td3_direction_catch_"
    title4 = "Test_success_hhqn_td3_direction_catch_"
    title5 = "Test_epioside_step_hhqn_td3_direction_catch_"
