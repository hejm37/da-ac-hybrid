...
https://github.com/TJU-DRL-LAB/self-supervised-rl/blob/ece95621b8c49f154f96cf7d395b95362a3b3d4e/RL_with_Action_Representation/HyAR/Raw_RL/main_platform_td3.py
...
def run(args):
    ...
    kwargs = {
        ...
        "tau": args.tau,
        "inverting_gradients": not args.no_inverting_gradients,
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument("--no_inverting_gradients", default=False, action="store_true")  # Whether to invert gradients
