...
https://github.com/TJU-DRL-LAB/self-supervised-rl/blob/ece95621b8c49f154f96cf7d395b95362a3b3d4e/RL_with_Action_Representation/HyAR/Raw_RL/main_direction_catch_pdqn_td3.py
...
def run(args):
    ...
    title2 = "Test_Reward_pdqn_td3_direction_catch_"
    title3 = "Test_success_pdqn_td3_direction_catch_"
    ...
    np.savetxt(os.path.join(redir, title2 + "{}".format(str(args.seed) + ".csv")), Test_Reward, delimiter=',')
