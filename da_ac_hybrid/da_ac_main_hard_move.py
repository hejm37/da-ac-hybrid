...
def run(args):
    ...
    print("save txt")
    dir = "result/DAAC/simple_move_4_direction_v1_"+"{}".format(args.action_n_dim)
    data = "log"
    redir = os.path.join(dir, data)
    if not os.path.exists(redir):
        os.makedirs(redir)
    print("redir", redir)
    title2 = "Reward_100_da_ac_simple_move_4_direction_v1_"
    title3 = "Test_Reward_da_ac_simple_move_4_direction_v1_"
    title4 = "Test_success_da_ac_simple_move_4_direction_v1_"
    title5 = "Test_epioside_step_da_ac_simple_move_4_direction_v1_"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", default='simple_move_4_direction_v1')  # Move environment
