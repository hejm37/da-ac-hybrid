...
def run(args):
    ...
    print("save txt")
    dir = "result/DAAC/hard_goal"
    data = "log"
    redir = os.path.join(dir, data)
    if not os.path.exists(redir):
        os.makedirs(redir)
    print("redir", redir)
    title2 = "Reward_100_da_ac_hard_goal_"
    title3 = "Test_Reward_100_da_ac_hard_goal_"
    title4 = "Test_epioside_step_100_da_ac_hard_goal_"
    title5 = "Test_success_rate_100_da_ac_hard_goal_"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", default='Goal-v0')  # Goal environment (made harder)
