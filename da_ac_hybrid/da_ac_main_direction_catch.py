...
def run(args):
    ...
    print("save txt")
    dir = "result/DAAC/direction_catch"
    data = "log"
    redir = os.path.join(dir, data)
    if not os.path.exists(redir):
        os.makedirs(redir)
    print("redir", redir)
    title2 = "Reward_100_da_ac_direction_catch_"
    title3 = "Test_Reward_da_ac_direction_catch_"
    title4 = "Test_success_da_ac_direction_catch_"
    title5 = "Test_epiosode_step_da_ac_direction_catch_"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", default='simple_catch')  # Catch Point environment
