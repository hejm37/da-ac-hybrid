...
https://github.com/TJU-DRL-LAB/self-supervised-rl/blob/ece95621b8c49f154f96cf7d395b95362a3b3d4e/RL_with_Action_Representation/HyAR/Raw_RL/main_platform_pdqn_td3.py
...
def run(args):
    ...
    if not os.path.exists(redir):
        os.makedirs(redir)
    print("redir", redir)
    # title1 = "Reward_pdqn_td3_platform_"
    title2 = "Test_Reward_100_pdqn_td3_platform_"
    title3 = "Test_epioside_steps_100_pdqn_td3_platform_"
