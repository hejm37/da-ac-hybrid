...
https://github.com/TJU-DRL-LAB/self-supervised-rl/blob/ece95621b8c49f154f96cf7d395b95362a3b3d4e/RL_with_Action_Representation/HyAR/Raw_RL/main_hard_move_td3.py
...
def run(args):
    ...
    print("save txt")
    dir = "result/TD3/simple_move_4_direction_v1_"+"{}".format(args.action_n_dim)
    data = "log"
    redir = os.path.join(dir, data)
    if not os.path.exists(redir):
        os.makedirs(redir)
    print("redir", redir)
    # title1 = "Reward_td3_simple_move_4_direction_v1"
    title2 = "Reward_100_td3_simple_move_4_direction_v1_"
    title3 = "Test_Reward_td3_simple_move_4_direction_v1_"
    title4 = "Test_success_td3_simple_move_4_direction_v1_"
    title5 = "Test_epioside_step_td3_simple_move_4_direction_v1_"
