...
https://github.com/TJU-DRL-LAB/self-supervised-rl/blob/ece95621b8c49f154f96cf7d395b95362a3b3d4e/RL_with_Action_Representation/HyAR/Raw_RL/main_hard_move_hhqn_td3.py
...
def evaluate(env, policy, max_steps, action_n_dim, episodes=100):
    returns = []
    success = []
    epioside_steps = []
    ...
    for _ in range(episodes):
        ...
        for j in range(max_steps):
            ...
            action = pad_action(discrete_action, all_parameter_action, action_n_dim)
...
def run(args):
    ...
    discrete_emb_dim = 2 ** action_n_dim
    parameter_emb_dim = 2 ** action_n_dim
    max_action = 1.0
    ...
    while total_timesteps < args.max_timesteps:
        ...
        for i in range(max_steps):
            ...
            next_action = pad_action(next_discrete_action, next_all_parameter_action,action_n_dim)
            ...
            if total_timesteps % args.eval_freq == 0:
                ...
                Test_Reward_50, Test_success_rate, Test_epioside_step_50 = evaluate(env, policy, max_steps=30,
    ...
    print("save txt")
    dir = "result/hhqn/simple_move_4_direction_v1_"+"{}".format(args.action_n_dim)
    data = "log"
    redir = os.path.join(dir, data)
    if not os.path.exists(redir):
        os.makedirs(redir)
    print("redir", redir)
    # title1 = "Reward_ddpg_simple_move_4_direction_v1"
    title2 = "Reward_100_hhqn_td3_simple_move_4_direction_v1_"
    title3 = "Test_Reward_hhqn_td3_simple_move_4_direction_v1_"
    title4 = "Test_success_hhqn_td3_simple_move_4_direction_v1_"
    title5 = "Test_epioside_step_hhqn_td3_simple_move_4_direction_v1_"
