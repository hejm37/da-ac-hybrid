...
https://github.com/TJU-DRL-LAB/self-supervised-rl/blob/ece95621b8c49f154f96cf7d395b95362a3b3d4e/RL_with_Action_Representation/HyAR/Raw_RL/main_hard_goal_hhqn_td3.py
...
def run(args):
    ...
    while total_timesteps < args.max_timesteps:
        ...
        for i in range(max_steps):
            ...
            if total_timesteps % args.eval_freq == 0:
                ...
                Test_Reward, Test_epioside_step, Test_success_rate = evaluate(env, policy,  episodes=100)
    ...
    title2 = "Reward_100_hhqn_td3_hard_goal_"
    title3 = "Test_Reward_100_hhqn_td3_hard_goal_"
    title4 = "Test_epioside_step_100_hhqn_td3_hard_goal_"
    title5 = "Test_success_rate_100_hhqn_td3_hard_goal_"
